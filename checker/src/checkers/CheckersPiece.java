...
/**
 * Interface for CheckersPiece. Checkers is a popular board game played between two players on a
 * square board divided into 64 squares of alternating colors (usually a light color and a dark
 * color).
 * The objective of the game is to capture or block all of your opponent's pieces, leaving them
 * with no valid moves, or to force your opponent into a position where they cannot make any more
 * moves.
 */
...
public interface CheckersPiece {
  ...
  /**
   * Returns true if the piece can move to the specified row and column, false otherwise.
